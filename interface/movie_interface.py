...
from models.utills import print_matrix_hall, cast_to_int
from models.validator import CinemaValidator
from models.exceptions import (MovieDoesntExist,
                               ProjectionDoesntExist)
from models.utills import (pretty_print_movie_projections,
                           pretty_print_movies)
...
class MovieInterface:
    ...
    def show_room_matrix_for_projection(self, proj_id):
